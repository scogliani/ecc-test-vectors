...
void init_ecc()
{
  if (!(secp192r1 = create_ecc(
            "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFF",
            "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFC",
            "64210519E59C80E70FA7E9AB72243049FEB8DEECC146B9B1",
            "188DA80EB03090F67CBF20EB43A18800F4FF0AFD82FF1012",
            "07192B95FFC8DA78631011ED6B24CDD573F977A11E794811",
            "FFFFFFFFFFFFFFFFFFFFFFFF99DEF836146BC9B1B4D22831", "01")))
  {
    goto err;
  }

  if (!(secp224r1 = create_ecc(
            "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF000000000000000000000001",
            "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFFFFFFFFFE",
            "B4050A850C04B3ABF54132565044B0B7D7BFD8BA270B39432355FFB4",
            "B70E0CBD6BB4BF7F321390B94A03C1D356C21122343280D6115C1D21",
            "BD376388B5F723FB4C22DFE6CD4375A05A07476444D5819985007E34",
            "FFFFFFFFFFFFFFFFFFFFFFFFFFFF16A2E0B8F03E13DD29455C5C2A3D", "01")))
  {
    goto err;
  }

  if (!(secp256r1 = create_ecc(
  ...
  if (!(secp384r1 = create_ecc("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF"
                               "FFFFFFFFFFFFFFFFEFFFFFFFF"
                               "0000000000000000FFFFFFFF",
                               "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF"
                               "FFFFFFFFFFFFFFFFEFFFFFFFF"
                               "0000000000000000FFFFFFFC",
                               "B3312FA7E23EE7E4988E056BE3F82D19181D9C6EFE81411"
                               "20314088F5013875AC656398D"
                               "8A2ED19D2A85C8EDD3EC2AEF",
                               "AA87CA22BE8B05378EB1C71EF320AD746E1D3B628BA79B9"
                               "859F741E082542A385502F25D"
                               "BF55296C3A545E3872760AB7",
                               "3617DE4A96262C6F5D9E98BF9292DC29F8F41DBD289A147"
                               "CE9DA3113B5F0B8C00A60B1CE"
                               "1D7E819D7A431D7C90EA0E5F",
                               "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF"
                               "FC7634D81F4372DDF581A0DB2"
